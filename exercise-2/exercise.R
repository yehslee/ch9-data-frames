...
# salaries (the negative number means that a salary may have decreased!)
  salaries_2018 <- salaries_2017 + c(runif(100, -5000, 10000))
...
# What was the 2018 salary of employee 57
  salaries[salaries$employees == "Employee 57", 'salaries_2018', 57]

# How many employees got a raise?
  nrow(salaries$change[salaries$got_raise == TRUE])
